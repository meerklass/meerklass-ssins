...
def run_notebook(index):
    ...
    parameter1 = {"Block": block[0], "pol":'h'}
     #parameter1 = {"Block": block[0], "pol":'v'}


    pm.execute_notebook("executable_ssins_iterative_flagging.ipynb", f"ssins_iterative_flags/output/output-notebook-{parameter1['Block']}-{parameter1['pol']}.ipynb", kernel_name =    "katcali", parameters=parameter1)
