#!/bin/bash
#SBATCH --job-name=ssins_b
#SBATCH --array=41-42  # SLURM job array index value, running job 0 to job 10 here
...
#SBATCH --output=logs/ssinsl0-%A-%a.out
...
python executable_ssins_bdist.py ${SLURM_ARRAY_TASK_ID}
